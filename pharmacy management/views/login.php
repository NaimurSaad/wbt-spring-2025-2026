...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <p>Manage pharmacists and medicines in one place. Sign in to access your dashboard.</p>
        <ul class="feature-list">
            <li>&#10003; Admin manages pharmacists</li>
            <li>&#10003; Pharmacists manage medicines</li>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="auth-foot">Don't have an account?
                <a href="index.php?page=register">Register as Pharmacist</a>
            </p>
